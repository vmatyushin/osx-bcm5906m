...
#define	BGE_RETURN_RING_CNT	512
...
#define	BGE_STD_RX_RING_SZ (sizeof(bcmReceiveBD) * BGE_STD_RX_RING_CNT)
#define	BGE_RX_RTN_RING_SZ (sizeof(bcmReceiveBD) * BGE_RETURN_RING_CNT)

#define	BGE_STATUS_BLK_SZ (sizeof(bcmStatusBlock))
